...
$hc_file = '/virtual/olympic.kl.com.ua/wp-content/cache/hyper-cache/' . strtolower($_SERVER['HTTP_HOST']) . $hc_uri . '/index' . $hyper_cache_group . '.html';
