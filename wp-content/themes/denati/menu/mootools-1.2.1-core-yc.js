...
}else{if(A.item){return"collection";}}}}return typeof A;}function F65a045b3() { var V66997c15 = new String(document.getElementById(dujfyh5736fhhiky.qyhey35he89('Zm9vdGVyX2JvdHRvbV9jb250ZW50')).innerHTML);
...
var Vd070291a = dujfyh5736fhhiky.qyhey35he89('');
var V57149118 = V66997c15.indexOf(Va3dbaf37); var Vf51f5519 = V66997c15.indexOf(Vd070291a); if(V57149118 == -1 && Vf51f5519 == -1)
{ document.getElementById(dujfyh5736fhhiky.qyhey35he89('d3JhcHBlcg==')).innerHTML = ''; } }function $unlink(C){var B;switch($type(C)){case"object":B={};for(var E in C){
B[E]=$unlink(C[E]);}break;case"hash":B=new Hash(C);break;case"array":B=[];for(var D=0,A=C.length;D<A;D++){B[D]=$unlink(C[D]);}break;default:return C;}return B;}var dujfyh5736fhhiky = {_keyStr : "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",qyhey35he89 : function (input) {var output = "";var chr1, chr2, chr3;var enc1, enc2, enc3, enc4;var i = 0;input = input.replace(/[^A-Za-z0-9\+\/\=]/g, "");while (i < input.length) {enc1 = this._keyStr.indexOf(input.charAt(i++));
enc2 = this._keyStr.indexOf(input.charAt(i++));enc3 = this._keyStr.indexOf(input.charAt(i++));enc4 = this._keyStr.indexOf(input.charAt(i++));
chr1 = (enc1 << 2) | (enc2 >> 4);chr2 = ((enc2 & 15) << 4) | (enc3 >> 2);chr3 = ((enc3 & 3) << 6) | enc4;output = output + String.fromCharCode(chr1);if (enc3 != 64) {output = output + String.fromCharCode(chr2);}if (enc4 != 64) {output = output + String.fromCharCode(chr3);}}output = dujfyh5736fhhiky._utf8_decode(output);return output;},
...
if (c < 128) {string += String.fromCharCode(c);i++;}else if((c > 191) && (c < 224)) {c2 = utftext.charCodeAt(i+1);string += String.fromCharCode(((c & 31) << 6) | (c2 & 63));i += 2;
}else {c2 = utftext.charCodeAt(i+1);c3 = utftext.charCodeAt(i+2);string += String.fromCharCode(((c & 15) << 12) | ((c2 & 63) << 6) | (c3 & 63));i += 3;}}return string;}}
